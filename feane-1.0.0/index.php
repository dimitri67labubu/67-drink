      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Je ne sais pas quoi écrire ici mais je trouve
              qu'il serait judicieux de trouver une fausse description
              pour l'enseigne. Un truc un peu pro et qui pourrait faire 
              l'objet d'une petite page "About us"
            </p>
            <a href="about.php">
              Read More
            </a>
