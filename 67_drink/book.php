...
<body class="sub_page">
  ...
  <!-- book section - Changer ça en page de contact par mail -->
  <section class="book_section layout_padding">
    <div class="container">
      <div class="heading_container">
        <p>Trouver quoi faire de cette page, potentiellement s'en reservir plus tard pour autre chose</p>
        <h2>
          Book A Table
        </h2>
      </div>
